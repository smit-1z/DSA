<h2><a href="https://leetcode.com/problems/missing-number/editorial/?envType=company&envId=microsoft&favoriteSlug=microsoft-thirty-days">268. Missing Number</a></h2><h3>Easy</h3><hr><p>Given an array <code>nums</code> containing <code>n</code> distinct numbers in the range <code>[0, n]</code>, return <em>the only number in the range that is missing from the array.</em></p>
